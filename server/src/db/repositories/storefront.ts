 ...
 * capa.
 */
const CAMPOS_DEL_SEGUIMIENTO = 'id,order_number,status,total,currency,fulfillment,created_at,payment_confirmed_at,order_items(product_name,variant_name,extras_names,item_note,quantity,line_total,order_item_options(option_group_name,option_name,quantity))' as const
