...
// Último pedido de UN contacto dentro de SU negocio. Alimenta el comprobante
// que llega por el chat: se leen los ítems del pedido que espera pago, y los
// precios NO se reutilizan nunca — los recalcula el catálogo vigente.
