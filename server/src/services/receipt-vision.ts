...
// `normalizarMonto` vive en `lib/montos.ts` desde el 2026-09-24: la carta del
// local también lee precios impresos, y cargar este módulo para eso mezclaba
// dos lectores que no tienen nada que ver. Se reexporta para quien ya lo usa.
export { normalizarMonto }
