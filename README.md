...
`chat_mode` y los índices para repetir pedidos (el modo `menu` que creó se
retiró el 2026-09-16: hoy la columna solo admite `miniapp`);
...
esos lotes. `migration-consumo-planes.sql` agrega después el libro mayor de
mensajes, los límites mensuales y la consulta de Medición del superadmin.
